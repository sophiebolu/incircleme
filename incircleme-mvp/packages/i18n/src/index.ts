...
export const strings = {
  ca: {
    ...
    // PROVISIONAL — Booking-Loop Stage 2 (ticket states + cancel sheet + chips). Pending Alina sign-off.
    tk_heldNoQr: 'Entrada reservada — el QR apareix quan et confirmin',
    tk_attended: 'Hi vas ser',
    // PROVISIONAL (host check-in 2a) — awaiting Vocab-Lock. CA imperative.
    tk_checkedIn: 'Has entrat',
    tk_checkedInSub: 'Ja estàs dins — gaudeix de l’esdeveniment',
    ck_hostedTitle: 'Els teus esdeveniments',
    ck_hostedEmptyTitle: 'Encara no tens esdeveniments',
    ck_hostedEmptyBody: 'Quan organitzis un esdeveniment, apareixerà aquí per fer el control d’accés.',
    ck_countSummary: '{checked}/{total} registrats',
    ck_statusUpcoming: 'Pròxim',
    ck_statusPast: 'Passat',
    ck_statusCancelled: 'Cancel·lat',
    ck_progress: '{checked} de {total} registrats',
    ck_rosterEmptyTitle: 'Encara no hi ha convidats',
    ck_rosterEmptyBody: 'Els convidats confirmats apareixeran aquí a mesura que reservin.',
    ck_checkedIn: 'Registrat',
    ck_cancel: 'Cancel·la',
    ck_confirm: 'Confirma',
    ck_checkInAction: 'Registra',
    ck_checkInName: 'Registra {name}',
    ck_guestFallback: 'Convidat/da',
    ck_resSuccess: 'Registrat ✓',
    ck_resAlready: 'Ja estava registrat',
    ck_resInvalidStatus: 'Aquesta reserva no es pot registrar',
    ck_resWrongEvent: 'Aquest tiquet és d’un altre esdeveniment',
    ck_resError: 'No s’ha pogut registrar — torna-ho a provar',
    tk_reviewCta: 'Explica com va anar',
    tk_cancelledRefunded: 'Cancel·lada · {amount} € retornats',
    tk_cancelledCredit: 'Cancel·lada · {amount} € de crèdit',
    tk_cancelledNoRefund: 'Cancel·lada',
    // Post-commit refund states — PROVISIONAL, flagged (not in the Vocabulary Lock; needs sign-off).
    ...
    cs_bodyCredit:
      'Falten menys de {hours}h, així que t’afegim {amount} € de crèdit per a un altre eveniment en lloc del reemborsament.',
    cs_bodyNoRefund: 'Falten menys de {hours}h, així que aquesta reserva no és reemborsable.',
    cs_depositRefund: 'Et tornarem els 5 € de la reserva.',
    cs_depositForfeit: 'Els 5 € de la reserva no es tornaran.',
    cs_confirm: 'Cancel·la l’entrada',
    cs_keep: 'Mantén l’entrada',
    cs_successTitle: 'Entrada cancel·lada',
    cs_errorRetry: 'No s’ha pogut fer. Torna-ho a provar.',
    chip_held: 'Reservada',
    chip_cancelled: 'Cancel·lada',
    chip_refunded: 'Retornada',
    chip_refundPending: 'Reemborsament pendent',
    chip_refundFailed: 'Reemborsament endarrerit',
    ...
    // Event-detail reviews section (3b) — PROVISIONAL, not in the Vocabulary Lock.
    evr_title: 'Ressenyes',
    evr_count: '{count} ressenyes',
    evr_wouldGoAgain: '{n} hi tornarien',
    evr_ratingA11y: 'Valoració {avg} sobre 5, de {count} ressenyes',
    evr_emptyTitle: 'Encara no hi ha ressenyes',
    evr_emptyBody: 'Sigues el primer/a a explicar com va anar.',
    evr_wouldGoAgainChip: 'Hi tornaria',
    evr_ratingCardA11y: 'Valoració {rating} de 5',
    evr_guestName: 'Un convidat/da',
  ...
  es: {
    ...
    // PROVISIONAL — Booking-Loop Stage 2. Pending Alina sign-off.
    tk_heldNoQr: 'Entrada reservada — el QR aparece cuando te confirmen',
    tk_attended: 'Estuviste allí',
    // PROVISIONAL (host check-in 2a) — awaiting Vocab-Lock. ES infinitive.
    tk_checkedIn: 'Has entrado',
    tk_checkedInSub: 'Ya estás dentro — disfruta del evento',
    ck_hostedTitle: 'Tus eventos',
    ck_hostedEmptyTitle: 'Aún no tienes eventos',
    ck_hostedEmptyBody: 'Cuando organices un evento, aparecerá aquí para controlar el acceso.',
    ck_countSummary: '{checked}/{total} registrados',
    ck_statusUpcoming: 'Próximo',
    ck_statusPast: 'Pasado',
    ck_statusCancelled: 'Cancelado',
    ck_progress: '{checked} de {total} registrados',
    ck_rosterEmptyTitle: 'Aún no hay invitados',
    ck_rosterEmptyBody: 'Los invitados confirmados aparecerán aquí a medida que reserven.',
    ck_checkedIn: 'Registrado',
    ck_cancel: 'Cancelar',
    ck_confirm: 'Confirmar',
    ck_checkInAction: 'Registrar',
    ck_checkInName: 'Registrar a {name}',
    ck_guestFallback: 'Invitado/a',
    ck_resSuccess: 'Registrado ✓',
    ck_resAlready: 'Ya estaba registrado',
    ck_resInvalidStatus: 'Esta reserva no se puede registrar',
    ck_resWrongEvent: 'Este billete es de otro evento',
    ck_resError: 'No se pudo registrar — inténtalo de nuevo',
    tk_reviewCta: 'Cuenta qué tal',
    tk_cancelledRefunded: 'Cancelada · {amount} € reembolsados',
    tk_cancelledCredit: 'Cancelada · {amount} € de crédito',
    tk_cancelledNoRefund: 'Cancelada',
    // Post-commit refund states — PROVISIONAL, flagged (not in the Vocabulary Lock; needs sign-off).
    ...
    cs_bodyCredit:
      'Faltan menos de {hours}h, así que te añadimos {amount} € de crédito para otro evento en lugar del reembolso.',
    cs_bodyNoRefund: 'Faltan menos de {hours}h, así que esta reserva no es reembolsable.',
    cs_depositRefund: 'Te devolveremos los 5 € de la reserva.',
    cs_depositForfeit: 'Los 5 € de la reserva no se devolverán.',
    cs_confirm: 'Cancelar mi entrada',
    cs_keep: 'Mantener mi entrada',
    cs_successTitle: 'Entrada cancelada',
    cs_errorRetry: 'No se ha podido. Inténtalo de nuevo.',
    chip_held: 'Reservada',
    chip_cancelled: 'Cancelada',
    chip_refunded: 'Reembolsada',
    chip_refundPending: 'Reembolso pendiente',
    chip_refundFailed: 'Reembolso retrasado',
    ...
    // Event-detail reviews section (3b) — PROVISIONAL, not in the Vocabulary Lock.
    evr_title: 'Reseñas',
    evr_count: '{count} reseñas',
    evr_wouldGoAgain: '{n} repetirían',
    evr_ratingA11y: 'Valoración {avg} sobre 5, de {count} reseñas',
    evr_emptyTitle: 'Aún no hay reseñas',
    evr_emptyBody: 'Sé el primero/a en contar cómo fue.',
    evr_wouldGoAgainChip: 'Repetiría',
    evr_ratingCardA11y: 'Valoración {rating} de 5',
    evr_guestName: 'Un invitado/a',
  ...
  en: {
    ...
    // PROVISIONAL — Booking-Loop Stage 2. Pending Alina sign-off.
    tk_heldNoQr: 'Ticket held — your QR appears once you’re confirmed',
    tk_attended: 'You were there',
    // PROVISIONAL (host check-in 2a) — awaiting Vocab-Lock.
    tk_checkedIn: 'Checked in',
    tk_checkedInSub: 'You’re all set — enjoy the event',
    ck_hostedTitle: 'Your events',
    ck_hostedEmptyTitle: 'No events yet',
    ck_hostedEmptyBody: 'When you host an event, it’ll show here so you can check guests in.',
    ck_countSummary: '{checked}/{total} checked in',
    ck_statusUpcoming: 'Upcoming',
    ck_statusPast: 'Past',
    ck_statusCancelled: 'Cancelled',
    ck_progress: '{checked} of {total} checked in',
    ck_rosterEmptyTitle: 'No guests yet',
    ck_rosterEmptyBody: 'Confirmed guests will appear here as people book.',
    ck_checkedIn: 'Checked in',
    ck_cancel: 'Cancel',
    ck_confirm: 'Confirm',
    ck_checkInAction: 'Check in',
    ck_checkInName: 'Check in {name}',
    ck_guestFallback: 'Guest',
    ck_resSuccess: 'Checked in ✓',
    ck_resAlready: 'Already checked in',
    ck_resInvalidStatus: 'This booking can’t be checked in',
    ck_resWrongEvent: 'This ticket is for another event',
    ck_resError: 'Couldn’t check in — try again',
    tk_reviewCta: 'Share how it went',
    tk_cancelledRefunded: 'Cancelled · €{amount} refunded',
    tk_cancelledCredit: 'Cancelled · €{amount} credit added',
    tk_cancelledNoRefund: 'Cancelled',
    // Post-commit refund states — PROVISIONAL, flagged (not in the Vocabulary Lock; needs sign-off).
    ...
    cs_bodyCredit:
      'It’s within {hours}h, so we’ll add €{amount} as credit for a future event instead of a refund.',
    cs_bodyNoRefund: 'It’s within {hours}h, so this booking isn’t refundable.',
    cs_depositRefund: 'Your €5 seat-hold will be returned.',
    cs_depositForfeit: 'Your €5 seat-hold won’t be returned.',
    cs_confirm: 'Cancel my ticket',
    cs_keep: 'Keep my ticket',
    cs_successTitle: 'Ticket cancelled',
    cs_errorRetry: 'That didn’t go through. Try again.',
    chip_held: 'Held',
    chip_cancelled: 'Cancelled',
    chip_refunded: 'Refunded',
    chip_refundPending: 'Refund pending',
    chip_refundFailed: 'Refund delayed',
    ...
    // Event-detail reviews section (3b) — PROVISIONAL, not in the Vocabulary Lock.
    evr_title: 'Reviews',
    evr_count: '{count} reviews',
    evr_wouldGoAgain: '{n} would go again',
    evr_ratingA11y: 'Rated {avg} out of 5, from {count} reviews',
    evr_emptyTitle: 'No reviews yet',
    evr_emptyBody: 'Be the first to share how it felt.',
    evr_wouldGoAgainChip: 'Would go again',
    evr_ratingCardA11y: 'Rated {rating} of 5',
    evr_guestName: 'A guest',
